...
export const workGroups: WorkGroup[] = [
  {
    ...
    summary:
      "Building the core canvas experience for an AI interior-design product, with a focus on real-time collaboration, infinite canvas editing, mobile experiences, and browser-based 2D-to-3D rendering.",
    featured: true,
    items: [
      {
