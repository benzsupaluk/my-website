    ...
    >
      <div className="flex items-baseline justify-between gap-6 md:block">
        <Link href="/" className="group block">
          <span className="block text-[15px] font-medium leading-tight tracking-tightest transition-colors duration-300 group-hover:text-ember md:text-lg">
            {site.name}
          </span>
                ...
                <li key={item.href} className="flex items-center gap-2">
                  <span
                    ...
                    className={clsx(
                      ...
                      active ? "w-4 bg-ember" : "w-0 bg-ink-faint"
                    )}
                  />
                  <Link
                    href={item.href}
      ...
      <div className="hidden flex-col gap-3 md:flex">
        ...
        <a
          ...
          className="link-underline w-fit font-mono text-[11px] text-ink-muted transition-colors duration-300 hover:text-ink-fg"
        >
          {site.email}
        </a>
        <LocalTime />
